...
I ran third-party and internal security audits against several services at an AI infrastructure startup, including a schema/validation library used as the entry point for LLM-driven "intent" processing. This was a service that took loosely-structured planning output from an LLM and validated it into a structured execution plan before anything downstream acted on it.
