# Infrastructure Security Scanning Guide
...
**No.** The security scanning is designed to be completely safe:
...
### Handling Results Without a Dedicated Security Team
**Common at early-stage startups:** many teams run this kind of scanning before they have a dedicated security function. Here's how that's handled:
- **Fixable vulnerabilities** - Update images when fixes are available
- **No-fix vulnerabilities** - Remain flagged in the Security tab until a vendor fix ships
- **Complex security issues** - May require external security consultation
...
### Important: Trivy Only Scans, Doesn't Fix
**What Trivy does:**
...
## Infrastructure Images We Monitor
